...
data %>% 
  ...
  xlab("SWEBOK") + ylab("Taxonomy") + guides(fill=guide_legend(title="")) + 
  theme_minimal() +
...
data %>% 
  ...
  xlab("Method") + ylab("Taxonomy") + guides(fill=guide_legend(title="")) + 
...
df.taxonomy %>%  
  ...
  scale_fill_discrete(name = "Cognitive Taxonomy Areas") + guides(size = F) +
